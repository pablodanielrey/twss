...
ver el bug de document loader de pyld.

https://github.com/digitalbazaar/pyld/pull/141
...
def my_requests_document_loader(secure=False, **kwargs):
    """
        ...
        try:
            ...
            if link_header:
                ...
                if (linked_alternate and
                    ...
                    """ 
                        esta linea la agrego 
                        https://github.com/digitalbazaar/pyld/pull/141/files
                    """
                    return loader(doc['documentUrl'], options=options)

            """
                ahora si, si no hay cabecera link, asumo que es un json asi que puedo obtenerlo
                https://github.com/digitalbazaar/pyld/pull/141/files 
            """
